...
# ------
CONF = 0.4
TRACKER = "tracktrack.yaml"       # botsort.yaml or bytetrack.yaml
CLASSES = [0, 2, 3, 5, 7]        # Detect specific classes, i.e person, car etc. 人、轿车、摩托、公交、卡车
...
EMA_ALPHA = 0.8                  # smoothing for centers (0..1). higher = follow new more   
...
if __name__ == "__main__":
    inference(
        ...
        source="many_people.mp4",
        output_path="many_people_track.mp4",
